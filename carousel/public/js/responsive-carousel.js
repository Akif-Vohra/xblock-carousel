    ...
    var t = "carousel",
        ...
        p = {
            ...
            _addNextPrev: function() {
                ...
                return e(this).append("<nav class='" + c + "'><a href='#prev' class='prev' aria-hidden='true' title='"+prevTitle+"'>"+previous+"</a><a href='#next' class='next' aria-hidden='true' title='"+nextTitle+"'>"+next+"</a></nav>")[t]("_bindEventListeners")
            },
            destroy: function() {}
        };
